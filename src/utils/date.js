export function timeSince(timeStamp) {
    ...
    const now = new Date(), secondsPast = (now.getTime() - timeStamp.getTime()) / 1000;
    ...
    if (secondsPast < 60) { // Less than a minute
        return Math.trunc(secondsPast) + 'secs';
    }
    if (secondsPast < 3600) { // Less than an hour
        return Math.trunc(secondsPast / 60) + 'mins';
    }
    if (secondsPast <= 86400) { // Less than a day
        return Math.trunc(secondsPast / 3600) + 'hrs';
    }
